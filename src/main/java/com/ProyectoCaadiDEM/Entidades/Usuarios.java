...
@NamedQueries({
    ...
    , @NamedQuery(name = "Usuarios.findByPassAndName", query = "SELECT u FROM Usuarios u WHERE u.nombre = :nombre AND u.pass = :pass")
...
public class Usuarios implements Serializable {
    ...
    public Usuarios(Integer id, String nombre, String pass) {
        this.id = id;
        this.nombre = nombre;
        this.pass = pass;
    }
